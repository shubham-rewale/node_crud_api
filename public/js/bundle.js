      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'there was some problem logging in try again');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2h1YmhhbXJld2FsZSIsImEiOiJja3dhYzhlbHYzOWM2MzByb3h3MTkyNmJuIn0.ckLNzhaLiDpAM-ovsNvAKg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/shubhamrewale/ckwajmjj904sx14mpxcjgtsbq',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " udated successfully"));
            }
